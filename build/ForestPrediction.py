...
def create_app():
      ...
      handler = KafkaHandler(producer=Producer,source='ML.uc4.ForestPrediction')
      ...
      def cfactor(name):
            ...
            try:
                  ...
                  def threadentry():
                        ...
                        app.logger.info("path is s3://"+s3_bucket_output+'/result-uc4-ForestPrediction/', extra={'logName': 'path'})
